    ...
    datasets: [
      {
        ...
        data: [119, 214, 63], // Valori giornalieri target (basati sul profilo)
    ...
    <div className="nutrition-stats">
      ...
      <div className="daily-goals">
        ...
        <div className="daily-goal-item">
          ...
          <span className="goal-value">1900 kcal</span>
        </div>
        <div className="daily-goal-item">
          <span className="goal-label">Proteine (25%)</span>
          <span className="goal-value">119g</span>
        </div>
        <div className="daily-goal-item">
          <span className="goal-label">Carboidrati (45%)</span>
          <span className="goal-value">214g</span>
        </div>
        <div className="daily-goal-item">
          <span className="goal-label">Grassi (30%)</span>
          <span className="goal-value">63g</span>
        </div>
      </div>
    </div>
  );
